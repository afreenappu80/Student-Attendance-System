...
import { FiUser, FiMail, FiPhone, FiMapPin, FiCamera, FiEdit2, FiBook, FiAward, FiBarChart2 } from 'react-icons/fi';
...
const StudentProfile = () => {
  ...
  const [profileData, setProfileData] = useState({
    ...
    email: user?.username || 'student@edutrack.com',
    phone: '',
    department: '',
    semester: '',
    rollNumber: '',
    ...
    const fetchProfile = async () => {
      try {
        ...
        setProfileData({
          ...
          semester: data.semester ? `${data.semester} Semester` : '',
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-start">
                      ...
                      <div className="flex-1">
                        ...
                        {isEditing ? (
                          <input type="text" className="w-full mt-1 p-2 border rounded-lg dark:bg-gray-700 dark:border-gray-600 dark:text-white focus:ring-2 focus:ring-blue-500" value={profileData.address} onChange={e => setProfileData({...profileData, address: e.target.value})} />
                        ) : (
